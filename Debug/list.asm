...
;	C:\TI_CodeComposer\ccsv8\tools\compiler\ti-cgt-arm_18.1.2.LTS\bin\armacpia.exe -@C:\\Users\\gminden\\AppData\\Local\\Temp\\{8F26834D-DA97-44F8-9BE6-B193793029B1} 
	.sect	".text"
	.clink
...
;----------------------------------------------------------------------
;  84 | pxList->pxIndex = ( ListItem_t * ) &( pxList->xListEnd );
;     |          /*lint !e826 !e740 The mini list structure is used as the list
;     |  end to save RAM.  This is checked and valid. */                       
;----------------------------------------------------------------------
        LDR       A1, [SP, #0]          ; [DPU_V7M3_PIPE] |84| 
        LDR       A2, [SP, #0]          ; [DPU_V7M3_PIPE] |84| 
        ADDS      A1, A1, #8            ; [DPU_V7M3_PIPE] |84| 
        STR       A1, [A2, #4]          ; [DPU_V7M3_PIPE] |84| 
...
;----------------------------------------------------------------------
        ...
        MOV       A2, #-1               ; [DPU_V7M3_PIPE] |88| 
        STR       A2, [A1, #8]          ; [DPU_V7M3_PIPE] |88| 
	.dwpsn	file "../Source/list.c",line 92,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
;  92 | pxList->xListEnd.pxNext = ( ListItem_t * ) &( pxList->xListEnd );
;     |  /*lint !e826 !e740 The mini list structure is used as the list end to 
;     | save RAM.  This is checked and valid. */                               
;----------------------------------------------------------------------
        LDR       A1, [SP, #0]          ; [DPU_V7M3_PIPE] |92| 
        LDR       A2, [SP, #0]          ; [DPU_V7M3_PIPE] |92| 
        ADDS      A1, A1, #8            ; [DPU_V7M3_PIPE] |92| 
        STR       A1, [A2, #12]         ; [DPU_V7M3_PIPE] |92| 
	.dwpsn	file "../Source/list.c",line 93,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
;  93 | pxList->xListEnd.pxPrevious = ( ListItem_t * ) &( pxList->xListEnd );/*
;     | lint !e826 !e740 The mini list structure is used as the list end to sav
;     | e RAM.  This is checked and valid. */                                  
;----------------------------------------------------------------------
        LDR       A1, [SP, #0]          ; [DPU_V7M3_PIPE] |93| 
        LDR       A2, [SP, #0]          ; [DPU_V7M3_PIPE] |93| 
        ADDS      A1, A1, #8            ; [DPU_V7M3_PIPE] |93| 
        STR       A1, [A2, #16]         ; [DPU_V7M3_PIPE] |93| 
...
;----------------------------------------------------------------------
        ...
        STR       A2, [A1, #16]         ; [DPU_V7M3_PIPE] |107| 
...
;----------------------------------------------------------------------
; 116 | void vListInsertEnd( List_t * const pxList, ListItem_t * const pxNewLis
;     | tItem )                                                                
;----------------------------------------------------------------------
...
$C$DW$14	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$14, DW_AT_location[DW_OP_breg13 8]
        ...
        STR       A2, [SP, #4]          ; [DPU_V7M3_PIPE] |117| 
        STR       A1, [SP, #0]          ; [DPU_V7M3_PIPE] |117| 
...
;----------------------------------------------------------------------
        LDR       A1, [SP, #8]          ; [DPU_V7M3_PIPE] |130| 
        LDR       A2, [SP, #4]          ; [DPU_V7M3_PIPE] |130| 
        LDR       A1, [A1, #8]          ; [DPU_V7M3_PIPE] |130| 
        STR       A1, [A2, #8]          ; [DPU_V7M3_PIPE] |130| 
	.dwpsn	file "../Source/list.c",line 135,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
; 135 | pxIndex->pxPrevious->pxNext = pxNewListItem;                           
;----------------------------------------------------------------------
        LDR       A2, [SP, #8]          ; [DPU_V7M3_PIPE] |135| 
        LDR       A1, [SP, #4]          ; [DPU_V7M3_PIPE] |135| 
        LDR       A2, [A2, #8]          ; [DPU_V7M3_PIPE] |135| 
        STR       A1, [A2, #4]          ; [DPU_V7M3_PIPE] |135| 
	.dwpsn	file "../Source/list.c",line 136,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
; 136 | pxIndex->pxPrevious = pxNewListItem;                                   
;----------------------------------------------------------------------
        LDR       A1, [SP, #4]          ; [DPU_V7M3_PIPE] |136| 
        LDR       A2, [SP, #8]          ; [DPU_V7M3_PIPE] |136| 
        STR       A1, [A2, #8]          ; [DPU_V7M3_PIPE] |136| 
...
;----------------------------------------------------------------------
        ...
        LDR       A2, [SP, #4]          ; [DPU_V7M3_PIPE] |139| 
        STR       A1, [A2, #16]         ; [DPU_V7M3_PIPE] |139| 
	.dwpsn	file "../Source/list.c",line 141,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
; 141 | ( pxList->uxNumberOfItems )++;                                         
;----------------------------------------------------------------------
        LDR       A2, [SP, #0]          ; [DPU_V7M3_PIPE] |141| 
        LDR       A1, [A2, #0]          ; [DPU_V7M3_PIPE] |141| 
        ADDS      A1, A1, #1            ; [DPU_V7M3_PIPE] |141| 
...
;----------------------------------------------------------------------
; 145 | void vListInsert( List_t * const pxList, ListItem_t * const pxNewListIt
;     | em )                                                                   
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
        LDR       A1, [SP, #4]          ; [DPU_V7M3_PIPE] |148| 
        LDR       A1, [A1, #0]          ; [DPU_V7M3_PIPE] |148| 
        STR       A1, [SP, #12]         ; [DPU_V7M3_PIPE] |148| 
...
;----------------------------------------------------------------------
        ...
        LDR       A1, [A1, #16]         ; [DPU_V7M3_PIPE] |166| 
        STR       A1, [SP, #8]          ; [DPU_V7M3_PIPE] |166| 
...
;----------------------------------------------------------------------
; 192 | for( pxIterator = ( ListItem_t * ) &( pxList->xListEnd ); pxIterator->p
;     | xNext->xItemValue <= xValueOfInsertion; pxIterator = pxIterator->pxNext
;     |  ) /*lint !e826 !e740 The mini list structure is used as the list end t
;     | o save RAM.  This is checked and valid. */                             
;----------------------------------------------------------------------
        LDR       A1, [SP, #0]          ; [DPU_V7M3_PIPE] |192| 
        ADDS      A1, A1, #8            ; [DPU_V7M3_PIPE] |192| 
        STR       A1, [SP, #8]          ; [DPU_V7M3_PIPE] |192| 
        B         ||$C$L3||             ; [DPU_V7M3_PIPE] |192| 
        ; BRANCH OCCURS {||$C$L3||}      ; [] |192| 
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../Source/list.c",line 192,column 114,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_V7M3_PIPE] |192| 
        LDR       A1, [A1, #4]          ; [DPU_V7M3_PIPE] |192| 
        STR       A1, [SP, #8]          ; [DPU_V7M3_PIPE] |192| 
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L3||
;* --------------------------------------------------------------------------*
||$C$L3||:    
	.dwpsn	file "../Source/list.c",line 192,column 61,is_stmt,isa 1
        LDR       A1, [SP, #8]          ; [DPU_V7M3_PIPE] |192| 
        LDR       A2, [A1, #4]          ; [DPU_V7M3_PIPE] |192| 
        LDR       A1, [SP, #12]         ; [DPU_V7M3_PIPE] |192| 
        LDR       A2, [A2, #0]          ; [DPU_V7M3_PIPE] |192| 
        CMP       A1, A2                ; [DPU_V7M3_PIPE] |192| 
        BCS       ||$C$L2||             ; [DPU_V7M3_PIPE] |192| 
...
;----------------------------------------------------------------------
        ...
        LDR       A1, [A1, #16]         ; [DPU_V7M3_PIPE] |216| 
...
;----------------------------------------------------------------------
        ...
        LDR       A2, [SP, #0]          ; [DPU_V7M3_PIPE] |219| 
        LDR       A1, [A1, #4]          ; [DPU_V7M3_PIPE] |219| 
        LDR       A2, [A2, #8]          ; [DPU_V7M3_PIPE] |219| 
        STR       A1, [A2, #4]          ; [DPU_V7M3_PIPE] |219| 
	.dwpsn	file "../Source/list.c",line 225,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
; 225 | if( pxList->pxIndex == pxItemToRemove )                                
;----------------------------------------------------------------------
        LDR       A2, [SP, #4]          ; [DPU_V7M3_PIPE] |225| 
        LDR       A1, [SP, #0]          ; [DPU_V7M3_PIPE] |225| 
        LDR       A2, [A2, #4]          ; [DPU_V7M3_PIPE] |225| 
        CMP       A1, A2                ; [DPU_V7M3_PIPE] |225| 
        BNE       ||$C$L5||             ; [DPU_V7M3_PIPE] |225| 
...
;----------------------------------------------------------------------
        ...
        LDR       A1, [A1, #8]          ; [DPU_V7M3_PIPE] |227| 
        STR       A1, [A2, #4]          ; [DPU_V7M3_PIPE] |227| 
...
;----------------------------------------------------------------------
        ...
        MOVS      A2, #0                ; [DPU_V7M3_PIPE] |234| 
        STR       A2, [A1, #16]         ; [DPU_V7M3_PIPE] |234| 
	.dwpsn	file "../Source/list.c",line 235,column 2,is_stmt,isa 1
;----------------------------------------------------------------------
; 235 | ( pxList->uxNumberOfItems )--;                                         
;----------------------------------------------------------------------
        LDR       A2, [SP, #4]          ; [DPU_V7M3_PIPE] |235| 
        LDR       A1, [A2, #0]          ; [DPU_V7M3_PIPE] |235| 
        SUBS      A1, A1, #1            ; [DPU_V7M3_PIPE] |235| 
        STR       A1, [A2, #0]          ; [DPU_V7M3_PIPE] |235| 
...
$C$DW$29	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$29, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$30	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$30, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$T$42	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$42, DW_AT_name("div_t")
	.dwattr $C$DW$T$42, DW_AT_type(*$C$DW$T$21)
	.dwattr $C$DW$T$42, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$42, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
	.dwattr $C$DW$T$42, DW_AT_decl_line(0x49)
	.dwattr $C$DW$T$42, DW_AT_decl_column(0x23)
...
$C$DW$31	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$31, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$32	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$32, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$T$43	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$43, DW_AT_name("ldiv_t")
	.dwattr $C$DW$T$43, DW_AT_type(*$C$DW$T$22)
	.dwattr $C$DW$T$43, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$43, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$33	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$33, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$34	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$34, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$T$44	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$44, DW_AT_name("lldiv_t")
	.dwattr $C$DW$T$44, DW_AT_type(*$C$DW$T$23)
	.dwattr $C$DW$T$44, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$44, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
	.dwattr $C$DW$T$44, DW_AT_decl_line(0x56)
	.dwattr $C$DW$T$44, DW_AT_decl_column(0x29)
...
$C$DW$35	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$35, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_types.h")
...
$C$DW$36	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$36, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_types.h")
...
$C$DW$T$45	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$45, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_types.h")
	.dwattr $C$DW$T$45, DW_AT_decl_line(0x72)
...
$C$DW$37	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$37, DW_AT_name("pucStartAddress")
	.dwattr $C$DW$37, DW_AT_TI_symbol_name("pucStartAddress")
	.dwattr $C$DW$37, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$37, DW_AT_accessibility(DW_ACCESS_public)
	.dwattr $C$DW$37, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18\Source\include\portable.h")
	.dwattr $C$DW$37, DW_AT_decl_line(0x96)
	.dwattr $C$DW$37, DW_AT_decl_column(0x0b)

$C$DW$38	.dwtag  DW_TAG_member
	.dwattr $C$DW$38, DW_AT_type(*$C$DW$T$28)
	.dwattr $C$DW$38, DW_AT_name("xSizeInBytes")
	.dwattr $C$DW$38, DW_AT_TI_symbol_name("xSizeInBytes")
	.dwattr $C$DW$38, DW_AT_data_member_location[DW_OP_plus_uconst 0x4]
	.dwattr $C$DW$38, DW_AT_accessibility(DW_ACCESS_public)
	.dwattr $C$DW$38, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18\Source\include\portable.h")
...
$C$DW$T$46	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$46, DW_AT_name("HeapRegion_t")
	.dwattr $C$DW$T$46, DW_AT_type(*$C$DW$T$29)
	.dwattr $C$DW$T$46, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$46, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18\Source\include\portable.h")
...
$C$DW$T$56	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$56, DW_AT_name("__TI_atexit_fn")
	.dwattr $C$DW$T$56, DW_AT_type(*$C$DW$T$55)
	.dwattr $C$DW$T$56, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$56, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
	.dwattr $C$DW$T$56, DW_AT_decl_line(0xb2)
...
$C$DW$T$62	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$62, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/machine/_types.h")
...
$C$DW$T$64	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$64, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/stdint.h")
...
$C$DW$T$66	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$66, DW_AT_decl_line(0x43)
...
$C$DW$T$68	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$68, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/stdint.h")
...
$C$DW$T$69	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$69, DW_AT_name("portCHAR")
	.dwattr $C$DW$T$69, DW_AT_type(*$C$DW$T$26)
	.dwattr $C$DW$T$69, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$69, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/portable/CCS/ARM_CM4F/portmacro.h")
...
$C$DW$T$73	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$73, DW_AT_decl_line(0x29)
	.dwattr $C$DW$T$73, DW_AT_decl_column(0x14)

$C$DW$T$74	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$74, DW_AT_name("portSHORT")
	.dwattr $C$DW$T$74, DW_AT_type(*$C$DW$T$73)
	.dwattr $C$DW$T$74, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$74, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/portable/CCS/ARM_CM4F/portmacro.h")
...
$C$DW$T$75	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$75, DW_AT_decl_line(0x76)
...
$C$DW$T$78	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$78, DW_AT_decl_line(0x6e)
...
$C$DW$T$80	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$80, DW_AT_decl_line(0x2e)
...
$C$DW$T$82	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$82, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
...
$C$DW$T$83	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$83, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_types.h")
...
$C$DW$T$84	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$84, DW_AT_decl_line(0x87)
...
$C$DW$T$85	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$85, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_types.h")
...
$C$DW$T$88	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$88, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdlib.h")
	.dwattr $C$DW$T$88, DW_AT_decl_line(0xb5)
	.dwattr $C$DW$T$88, DW_AT_decl_column(0x13)

$C$DW$T$89	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$89, DW_AT_name("__cpulevel_t")
...
$C$DW$T$90	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$90, DW_AT_name("__cpusetid_t")
	...
	.dwattr $C$DW$T$90, DW_AT_decl_line(0x4c)
	.dwattr $C$DW$T$90, DW_AT_decl_column(0x0e)

$C$DW$T$91	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$91, DW_AT_name("__cpuwhich_t")
...
$C$DW$T$92	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$92, DW_AT_name("__ct_rune_t")
...
$C$DW$T$93	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$93, DW_AT_name("__rune_t")
	...
	.dwattr $C$DW$T$93, DW_AT_decl_line(0x61)
	.dwattr $C$DW$T$93, DW_AT_decl_column(0x15)

$C$DW$T$94	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$94, DW_AT_name("__wint_t")
...
$C$DW$T$99	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$99, DW_AT_decl_line(0x55)
...
$C$DW$T$105	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$105, DW_AT_name("__int_least32_t")
	...
	.dwattr $C$DW$T$105, DW_AT_decl_line(0x5a)
	.dwattr $C$DW$T$105, DW_AT_decl_column(0x13)

$C$DW$T$106	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$106, DW_AT_name("int_least32_t")
	...
	.dwattr $C$DW$T$106, DW_AT_decl_line(0x2a)
	.dwattr $C$DW$T$106, DW_AT_decl_column(0x1a)

$C$DW$T$107	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$107, DW_AT_name("__intfptr_t")
...
$C$DW$T$108	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$108, DW_AT_name("__intptr_t")
...
$C$DW$T$109	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$109, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_stdint.h")
	.dwattr $C$DW$T$109, DW_AT_decl_line(0x4c)
	.dwattr $C$DW$T$109, DW_AT_decl_column(0x15)

$C$DW$T$110	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$110, DW_AT_name("__lwpid_t")
...
$C$DW$T$111	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$111, DW_AT_name("__pid_t")
	...
	.dwattr $C$DW$T$111, DW_AT_decl_line(0x3f)
...
$C$DW$T$113	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$113, DW_AT_decl_line(0x5d)
...
$C$DW$T$115	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$115, DW_AT_type(*$C$DW$T$95)
...
$C$DW$T$116	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$116, DW_AT_type(*$C$DW$T$95)
	.dwattr $C$DW$T$116, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$116, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_stdint.h")
	.dwattr $C$DW$T$116, DW_AT_decl_line(0x2e)
	.dwattr $C$DW$T$116, DW_AT_decl_column(0x14)

$C$DW$T$117	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$117, DW_AT_name("BaseType_t")
	.dwattr $C$DW$T$117, DW_AT_type(*$C$DW$T$116)
	.dwattr $C$DW$T$117, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$117, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/portable/CCS/ARM_CM4F/portmacro.h")
	.dwattr $C$DW$T$117, DW_AT_decl_line(0x69)
	.dwattr $C$DW$T$117, DW_AT_decl_column(0x12)

$C$DW$T$118	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$118, DW_AT_name("portBASE_TYPE")
	.dwattr $C$DW$T$118, DW_AT_type(*$C$DW$T$116)
	.dwattr $C$DW$T$118, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$118, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/portable/CCS/ARM_CM4F/portmacro.h")
	.dwattr $C$DW$T$118, DW_AT_decl_line(0x66)
	.dwattr $C$DW$T$118, DW_AT_decl_column(0x12)

$C$DW$T$119	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$119, DW_AT_name("portLONG")
	.dwattr $C$DW$T$119, DW_AT_type(*$C$DW$T$116)
	.dwattr $C$DW$T$119, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$119, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/portable/CCS/ARM_CM4F/portmacro.h")
	.dwattr $C$DW$T$119, DW_AT_decl_line(0x63)
	.dwattr $C$DW$T$119, DW_AT_decl_column(0x12)

$C$DW$T$120	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$120, DW_AT_name("__nl_item")
...
$C$DW$T$121	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$121, DW_AT_name("ptrdiff_t")
	.dwattr $C$DW$T$121, DW_AT_type(*$C$DW$T$10)
	.dwattr $C$DW$T$121, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$121, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stddef.h")
...
$C$DW$T$133	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$133, DW_AT_decl_line(0x6b)
...
$C$DW$T$135	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$135, DW_AT_name("__uint_fast8_t")
...
$C$DW$T$136	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$136, DW_AT_name("uint_fast8_t")
...
$C$DW$T$137	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$137, DW_AT_name("__uint_least32_t")
	...
	.dwattr $C$DW$T$137, DW_AT_decl_line(0x6f)
	.dwattr $C$DW$T$137, DW_AT_decl_column(0x14)

$C$DW$T$138	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$138, DW_AT_name("__char32_t")
...
$C$DW$T$139	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$139, DW_AT_name("uint_least32_t")
...
$C$DW$T$140	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$140, DW_AT_name("__uintfptr_t")
...
$C$DW$T$141	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$141, DW_AT_name("__uintptr_t")
...
$C$DW$T$142	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$142, DW_AT_name("uintptr_t")
	.dwattr $C$DW$T$142, DW_AT_type(*$C$DW$T$141)
	.dwattr $C$DW$T$142, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$142, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_stdint.h")
	.dwattr $C$DW$T$142, DW_AT_decl_line(0x50)
	.dwattr $C$DW$T$142, DW_AT_decl_column(0x16)

$C$DW$T$143	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$143, DW_AT_name("__vm_offset_t")
...
$C$DW$T$144	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$144, DW_AT_name("__vm_paddr_t")
...
$C$DW$T$145	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$145, DW_AT_name("__vm_size_t")
...
$C$DW$T$146	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$146, DW_AT_name("StackType_t")
	.dwattr $C$DW$T$146, DW_AT_type(*$C$DW$T$32)
	.dwattr $C$DW$T$146, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$146, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/portable/CCS/ARM_CM4F/portmacro.h")
...
$C$DW$T$149	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$149, DW_AT_name("portSTACK_TYPE")
	.dwattr $C$DW$T$149, DW_AT_type(*$C$DW$T$32)
	...
	.dwattr $C$DW$T$149, DW_AT_decl_line(0x65)
...
$C$DW$T$151	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$151, DW_AT_name("__key_t")
...
$C$DW$T$153	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$153, DW_AT_name("__int64_t")
...
$C$DW$T$154	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$154, DW_AT_name("__blkcnt_t")
...
$C$DW$T$155	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$155, DW_AT_name("__id_t")
...
$C$DW$T$156	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$156, DW_AT_name("__int_fast64_t")
	...
	.dwattr $C$DW$T$156, DW_AT_decl_line(0x57)
	.dwattr $C$DW$T$156, DW_AT_decl_column(0x13)

$C$DW$T$157	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$157, DW_AT_name("int_fast64_t")
...
$C$DW$T$158	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$158, DW_AT_name("__int_least64_t")
...
$C$DW$T$159	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$159, DW_AT_name("int_least64_t")
	...
	.dwattr $C$DW$T$159, DW_AT_decl_line(0x2b)
	.dwattr $C$DW$T$159, DW_AT_decl_column(0x1a)

$C$DW$T$160	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$160, DW_AT_name("__intmax_t")
	...
	.dwattr $C$DW$T$160, DW_AT_decl_line(0x52)
	.dwattr $C$DW$T$160, DW_AT_decl_column(0x13)

$C$DW$T$161	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$161, DW_AT_name("intmax_t")
	.dwattr $C$DW$T$161, DW_AT_type(*$C$DW$T$160)
	.dwattr $C$DW$T$161, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$161, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_stdint.h")
	.dwattr $C$DW$T$161, DW_AT_decl_line(0x54)
	.dwattr $C$DW$T$161, DW_AT_decl_column(0x15)

$C$DW$T$162	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$162, DW_AT_name("__off64_t")
...
$C$DW$T$163	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$163, DW_AT_name("__off_t")
...
$C$DW$T$164	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$164, DW_AT_name("__rlim_t")
	.dwattr $C$DW$T$164, DW_AT_type(*$C$DW$T$153)
...
$C$DW$T$165	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$165, DW_AT_name("int64_t")
	.dwattr $C$DW$T$165, DW_AT_type(*$C$DW$T$153)
	.dwattr $C$DW$T$165, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$165, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_stdint.h")
	.dwattr $C$DW$T$165, DW_AT_decl_line(0x33)
	.dwattr $C$DW$T$165, DW_AT_decl_column(0x14)

$C$DW$T$166	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$166, DW_AT_name("portDOUBLE")
...
$C$DW$T$167	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$167, DW_AT_name("__uint64_t")
	...
	.dwattr $C$DW$T$167, DW_AT_decl_line(0x48)
	.dwattr $C$DW$T$167, DW_AT_decl_column(0x1c)

$C$DW$T$168	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$168, DW_AT_name("__dev_t")
	...
	.dwattr $C$DW$T$168, DW_AT_decl_line(0x74)
	.dwattr $C$DW$T$168, DW_AT_decl_column(0x14)

$C$DW$T$169	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$169, DW_AT_name("__fsblkcnt_t")
...
$C$DW$T$170	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$170, DW_AT_name("__fsfilcnt_t")
...
$C$DW$T$171	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$171, DW_AT_name("__ino_t")
...
$C$DW$T$172	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$172, DW_AT_name("__nlink_t")
...
$C$DW$T$173	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$173, DW_AT_name("__uint_fast64_t")
	...
	.dwattr $C$DW$T$173, DW_AT_decl_line(0x6c)
...
$C$DW$T$175	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$175, DW_AT_name("__uint_least64_t")
	...
	.dwattr $C$DW$T$175, DW_AT_decl_line(0x70)
	.dwattr $C$DW$T$175, DW_AT_decl_column(0x14)

$C$DW$T$176	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$176, DW_AT_name("uint_least64_t")
	.dwattr $C$DW$T$176, DW_AT_type(*$C$DW$T$175)
	.dwattr $C$DW$T$176, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$176, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/stdint.h")
	.dwattr $C$DW$T$176, DW_AT_decl_line(0x30)
	.dwattr $C$DW$T$176, DW_AT_decl_column(0x1a)

$C$DW$T$177	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$177, DW_AT_name("__uintmax_t")
...
$C$DW$T$178	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$178, DW_AT_name("__rman_res_t")
	...
	.dwattr $C$DW$T$178, DW_AT_decl_line(0x8f)
	.dwattr $C$DW$T$178, DW_AT_decl_column(0x19)

$C$DW$T$179	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$179, DW_AT_name("uintmax_t")
...
$C$DW$T$180	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$180, DW_AT_name("uint64_t")
	.dwattr $C$DW$T$180, DW_AT_type(*$C$DW$T$167)
	.dwattr $C$DW$T$180, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$180, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/sys/_stdint.h")
...
$C$DW$T$181	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$181, DW_AT_name("__float_t")
...
$C$DW$T$182	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$182, DW_AT_name("portFLOAT")
...
$C$DW$T$183	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$183, DW_AT_name("__double_t")
	.dwattr $C$DW$T$183, DW_AT_type(*$C$DW$T$17)
	...
	.dwattr $C$DW$T$183, DW_AT_decl_line(0x4f)
...
$C$DW$T$184	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$184, DW_AT_name("max_align_t")
	.dwattr $C$DW$T$184, DW_AT_type(*$C$DW$T$18)
	.dwattr $C$DW$T$184, DW_AT_language(DW_LANG_C)
	.dwattr $C$DW$T$184, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stddef.h")
...
$C$DW$T$186	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$186, DW_AT_name("__mqd_t")
...
$C$DW$T$188	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$188, DW_AT_name("__timer_t")
	...
	.dwattr $C$DW$T$188, DW_AT_decl_line(0x46)
...
$C$DW$42	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$42, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/machine/_types.h")
...
$C$DW$T$189	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$189, DW_AT_decl_line(0x89)
...
$C$DW$T$190	.dwtag  DW_TAG_typedef
	...
	.dwattr $C$DW$T$190, DW_AT_decl_file("C:/TI_CodeComposer/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include/stdarg.h")
...
$C$DW$43	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$43, DW_AT_decl_line(0xd0)
...
$C$DW$44	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$44, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/include/list.h")
	.dwattr $C$DW$44, DW_AT_decl_line(0xd1)
...
$C$DW$45	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$45, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/include/list.h")
	.dwattr $C$DW$45, DW_AT_decl_line(0xd2)
...
$C$DW$T$47	.dwtag  DW_TAG_typedef
	.dwattr $C$DW$T$47, DW_AT_name("List_t")
	...
	.dwattr $C$DW$T$47, DW_AT_decl_line(0xd4)
...
$C$DW$46	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$46, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/include/list.h")
...
$C$DW$47	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$47, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/include/list.h")
	.dwattr $C$DW$47, DW_AT_decl_line(0xb9)
...
$C$DW$48	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$48, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/include/list.h")
	.dwattr $C$DW$48, DW_AT_decl_line(0xba)
...
$C$DW$49	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$49, DW_AT_decl_file("C:\Projects\EECS_388_Test_Workspace\EECS_388_Base_Project_Fa18/Source/include/list.h")
	.dwattr $C$DW$49, DW_AT_decl_line(0xbb)
...
$C$DW$50	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$50, DW_AT_decl_line(0xbc)
...
$C$DW$68	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$68, DW_AT_name("LR")
	.dwattr $C$DW$68, DW_AT_location[DW_OP_reg14]

$C$DW$69	.dwtag  DW_TAG_TI_assign_register
	.dwattr $C$DW$69, DW_AT_name("PC")
